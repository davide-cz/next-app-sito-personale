...
/*const [isEven, setIsEven]=useState(false);*/
    ...
    return (
        <div  className={`flex flex-col px-2 pt-4 gap-4 h-full max-h-[700px] w-full saturate-50 bg-linear-to-b   from-stone-900 via-purple-500 to-stone-900 ${isEven ? 'lg:flex-row justify-aroud md:justify-between' : 'lg:flex-row-reverse md:justify-between' }  `} >

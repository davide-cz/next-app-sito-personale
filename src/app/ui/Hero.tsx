    ...
    return (
        <section className="flex w-full h-screen relative">
            ...
            <div className="text-center m-auto" >
                <h1 className="mx-auto p-2 text-5xl sm:text-7xl font-bold text-stone-600" >DC-Web-Dev</h1>
                <h2 className="mx-auto p-2 text-3xl sm:text-5xl text-stone-400" >Benvenuto su Dc-web developer</h2>
                <h5 className="mx-auto p-2 text-xl sm:text-3xl text-stone-700" >Sono un appassionato di sviluppo web sia lato 
